  ...
  return (
    <div className="min-h-screen p-6 md:p-12">
      <div className="max-w-5xl mx-auto">
        <h1 className="text-3xl font-bold mb-8 text-gray-800">📂 Mis Postulaciones</h1>
                ...
                <div key={soli.id} className="bg-white p-6 rounded-2xl shadow-md border border-gray-100">
                    ...
                    {editingId === soli.id ? (
                        <form onSubmit={handleUpdate} className="space-y-4 bg-blue-50 p-4 rounded-xl">
                            ...
                            <input 
                                ...
                                accept=".pdf" // tipo de archivo
                                className="w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 transition-colors cursor-pointer" // <--- Estilos bonitos
                            />
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                        <div>
                            ...
                            <p className="text-gray-700 font-medium">{soli.mensaje}</p>
